...
portal-url-parameter-test: Portal URL Parameter test Portlet
============================
Author: Thomas Heute, Peter Palaga, Martin Weiler  
Level: Beginner  
Technologies: Portlet  
Summary: A portlet to test URL parameters.  
...
This project shows how to access URL parameters in a portlet, and has been created to verify [https://issues.jboss.org/browse/GTNPORTAL-3389](GTNPORTAL-3389).

Test instructions:
* Build the portlet
* Deploy target/portal-url-parameter-test-portlet.war to the JPP/GateIn instance
* Start the JPP/GateIn instance, log in as root, and import the portlet to the application registry
* Create a new page 'restricted', add the 'Portal URL Parameter Test Portlet' to the page, and define the read permissions for the page as '*:/platform/users'
* Access the page with added URL parameter 'myparameter': [http://localhost:8080/portal/classic/restricted?myparameter=logged_in](http://localhost:8080/portal/classic/restricted?myparameter=logged_in)
* Log out
* Access the restricted page: [http://localhost:8080/portal/classic/restricted?myparameter=before_login](http://localhost:8080/portal/classic/restricted?myparameter=before_login)
* Enter credendials, and verify if the URL parameters are still available
